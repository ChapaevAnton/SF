package archipov.string_search;
...
public class Main {
    ...
    //Алгоритм поиска в строке: наивный
    private static ArrayList<Integer> searchNaive(String text, String sample) {
        ArrayList<Integer> foundPosition = new ArrayList<>();
        for (int i = 0; i < text.length(); i++) {
            int j = 0; // указывает на текущую позицию внутри образца(sample)
    ...
    //Алгоритм поиска в строке Кнута-Морисса-Пратта
