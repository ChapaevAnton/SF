...
public class SetRunner {
    ...
    public static void main(String[] args) {
        ...
        Set<Car> europaCar = new HashSet<>();
        europaCar.add(new Car("Toyota", "Auris", 40));
        europaCar.add(new Car("Reno", "Clio", 30));
        europaCar.add(new Car("Reno", "Megan", 50));
        europaCar.add(new Car("VW", "Golf", 45));
        europaCar.add(new Car("VW", "Polo", 35));

        NavigableSet<Car> uniqueCars = new TreeSet<>(sixCars);
        uniqueCars.addAll(europaCar);
//
//        print(uniqueCars);
//        System.out.println();
    ...
    private static void print(Set<Car> cars) {
        ...
        for (Car car : cars)
            System.out.printf("%-20s %-20s %-20s \n", car.getCarBrend(), car.getModel(), car.getPricePerDay());
    }
}
